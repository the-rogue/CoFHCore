...
public abstract class GuiBase extends GuiContainer
{
	...
	public static void playSound(String name, float volume, float pitch, SoundCategory category)
	{

		guiSoundManager.playSound(new SoundBase(name, volume, pitch, category));
	}
